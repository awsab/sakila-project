 ...
 * User     : ramup
 * Date     : 20/04/2026
 * Usage    : Shared WebMvc configuration provided by awsab-framework.
 *            Registers {@link AwsabLoggingInterceptor} for /api/** and applies
...
public class AwsabWebMvcConfigurer implements WebMvcConfigurer {

    private final AwsabLoggingInterceptor loggingInterceptor;
