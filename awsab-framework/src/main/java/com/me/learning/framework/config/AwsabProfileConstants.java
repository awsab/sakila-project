 ...
 * User     : ramup
 * Date     : 23/07/2025
 * Usage    : Well-known Spring profile name constants shared across all AWSAB microservices
 * Since    : Version 1.0
 */
package com.me.learning.framework.config;

/**
 * Canonical Spring profile name constants used across all AWSAB microservices.
 *
 ...
 * string literals.
 */
public final class AwsabProfileConstants {

    private AwsabProfileConstants() {
    }
